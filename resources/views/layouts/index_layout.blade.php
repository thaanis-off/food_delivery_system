        ...
        <div class="container px-4 px-lg-5">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2  mb-lg-0 ms-lg-4">
                    ...
                    <a class="nav-link active" aria-current="page" href="{{ route('resturantsView') }}">
                        <li class="nav-item">Resturants</li>
                    </a>


                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" id="navbarDropdown" href="#" role="button"
                            data-bs-toggle="dropdown" aria-expanded="false">Foods</a>
                ...
                <div class="cont">
                    <form action="https://www.google.com/search" class="search" id="search-bar">
                        <input type="search" placeholder="Search your favourite..." name="search"
                            class="search__input">
                ...
                <li class="nav-item dropdown nameBar" style="margin-left: 50px;">
                    <a class="nav-link dropdown-toggle" id="navbarDropdown" href="#" role="button"
                        data-bs-toggle="dropdown" aria-expanded="false"><i class="bi bi-person-fill me-2"></i>Thaanis
                        M</a>
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <div class="row">
                ...
                <div class="col-6 col-md-2 mb-3  py-4 mb-2">
                    ...
                    <ul class="nav flex-column company-txt">
                        <li class="nav-item mb-2 text-white"><a href="#"
                ...
                <div class="col-6 col-md-2 mb-3 ftr-hdng py-4" style="margin-left: 200px;">
                    ...
                    <ul class="nav flex-column gt-in-tch">
                        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">+94 777557990</a>
                        </li>
                        <li class="nav-item mb-2"><a href="#"
                                class="nav-link p-0 text-white">thasnimthaanish@gmail.com</a></li>
