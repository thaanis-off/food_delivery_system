            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select @if ($errors->has('status')) {{ 'is-invalid' }} @endif"
                        ...
                        <option value="1" @if (old('status') == '1') selected @endif>Opened Now</option>
                        <option value="0" @if (old('status') == '0') selected @endif>Closed Now</option>
                    </select>
            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    ...
                    <textarea name="description" id="description" style="resize: none; height: 150px;" ;
                        ...
                        placeholder="Enter resturant description">{{ old('description') }}</textarea>
